import{o as U,r as _,u as R,k as G,b as W,j as r,p as H,q as K}from"./index-91b3330c.js";import{_ as J,w as Q,T as X,g as Y,s as Z,r as V,u as ee,i as te}from"./emotion-element-c39617d8.browser.esm-2eddb687.js";import{F as ae,E as re,c as M,d as ie,a as oe,b as z,e as ne,f as se,g as de}from"./index.esm-75162d7a.js";var le=U,ce=function(e){return e!=="theme"},A=function(e){return typeof e=="string"&&e.charCodeAt(0)>96?le:ce},L=function(e,a,t){var o;if(a){var p=a.shouldForwardProp;o=e.__emotion_forwardProp&&p?function(u){return e.__emotion_forwardProp(u)&&p(u)}:p}return typeof o!="function"&&t&&(o=e.__emotion_forwardProp),o},he=function(e){var a=e.cache,t=e.serialized,o=e.isStringTag;return V(a,t,o),ee(function(){return te(a,t,o)}),null},pe=function i(e,a){var t=e.__emotion_real===e,o=t&&e.__emotion_base||e,p,u;a!==void 0&&(p=a.label,u=a.target);var w=L(e,a,t),g=w||A(o),P=!g("as");return function(){var f=arguments,x=t&&e.__emotion_styles!==void 0?e.__emotion_styles.slice(0):[];if(p!==void 0&&x.push("label:"+p+";"),f[0]==null||f[0].raw===void 0)x.push.apply(x,f);else{x.push(f[0][0]);for(var N=f.length,h=1;h<N;h++)x.push(f[h],f[0][h])}var s=Q(function(d,v,$){var S=P&&d.as||o,y="",l=[],c=d;if(d.theme==null){c={};for(var m in d)c[m]=d[m];c.theme=_.useContext(X)}typeof d.className=="string"?y=Y(v.registered,l,d.className):d.className!=null&&(y=d.className+" ");var k=Z(x.concat(l),v.registered,c);y+=v.key+"-"+k.name,u!==void 0&&(y+=" "+u);var F=P&&w===void 0?A(S):g,j={};for(var b in d)P&&b==="as"||F(b)&&(j[b]=d[b]);return j.className=y,j.ref=$,_.createElement(_.Fragment,null,_.createElement(he,{cache:v,serialized:k,isStringTag:typeof S=="string"}),_.createElement(S,j))});return s.displayName=p!==void 0?p:"Styled("+(typeof o=="string"?o:o.displayName||o.name||"Component")+")",s.defaultProps=e.defaultProps,s.__emotion_real=s,s.__emotion_base=o,s.__emotion_styles=x,s.__emotion_forwardProp=w,Object.defineProperty(s,"toString",{value:function(){return"."+u}}),s.withComponent=function(d,v){return i(d,J({},a,v,{shouldForwardProp:L(s,v,!0)})).apply(void 0,x)},s}},me=["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","marquee","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","title","tr","track","u","ul","var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","tspan"],n=pe.bind();me.forEach(function(i){n[i]=n(i)});const q=i=>i.intake.intake,T=n.li`
...
@media only screen and (min-width: 834px){
  ...
  gap: 12px;
  margin-top: 120px; 
  }`,B=M({dish:ie().of(M().shape({name:oe().required("Enter a name dish").min(2,"Very short"),carbonohidrates:z().required("Enter a number").max(999.99,"Maximum 999.99"),protein:z().required("Enter a number").max(999.99,"Maximum 999.99"),fat:z().required("Enter a number").max(999.99,"Maximum 999.99"),calories:z().required("Enter a number").max(999.99,"Maximum 999.99")}))}),D={name:"",carbonohidrates:"",protein:"",fat:"",calories:""},Be=({name:i,img:e,onClose:a,requestType:t,idIntake:o})=>{var v,$,S,y;const p=R(),[u,w]=_.useState(""),g=()=>{w("validation")};_.useEffect(()=>{const l=document.body.style.overflow,c=m=>{m.code==="Escape"&&a()};return window.addEventListener("keydown",c),document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",c),document.body.style.overflow=l}},[a]);const P=l=>{l.currentTarget===l.target&&a()},f=l=>{if(t==="POST"){const c={[i.toLowerCase()]:{dish:l.dish.map(m=>({name:m.name,carbonohidrates:parseFloat(m.carbonohidrates),protein:parseFloat(m.protein),fat:parseFloat(m.fat),calories:parseFloat(m.calories)}))}};p(H(c))}else if(t==="PUT"){const c={[i.toLowerCase()]:{dish:[{name:l.dish[0].name,carbonohidrates:parseFloat(l.dish[0].carbonohidrates),protein:parseFloat(l.dish[0].protein),fat:parseFloat(l.dish[0].fat),calories:parseFloat(l.dish[0].calories)}]}};console.log(o),console.log(c),p(K({id:o,intakeData:c}))}a()},x=4,N=(l,{values:c,setFieldValue:m,errors:k})=>{if(l.preventDefault(),t==="PUT")return;if(c.dish.some((j,b)=>!!(k.dish&&k.dish[b]))){w("validation");return}if(c.dish.length<x){const j=c.dish.length-1,b=c.dish[j];B.validate(b,{abortEarly:!1}).then(()=>{m("dish",[...c.dish,D])})}else return},h=W(q);let s;switch(i){case"breakfast":s=(v=h==null?void 0:h.breakfast)==null?void 0:v.dish;break;case"lunch":s=($=h==null?void 0:h.lunch)==null?void 0:$.dish;break;case"dinner":s=(S=h==null?void 0:h.dinner)==null?void 0:S.dish;break;case"snack":s=(y=h==null?void 0:h.snack)==null?void 0:y.dish;break;default:s=null;break}const d=t==="PUT"?s.find(l=>l._id===o):null;return r.jsx(Se,{onClick:P,children:r.jsxs(Fe,{children:[r.jsx(Ee,{children:"Record your meal"}),r.jsxs(Ce,{children:[r.jsx("img",{src:e,alt:i}),r.jsx(Ie,{children:i})]}),r.jsx(ne,{initialValues:t==="PUT"?{dish:s&&s.length?[{name:d.name||"",carbonohidrates:d.carbonohidrates||"",protein:d.protein||"",fat:d.fat||"",calories:d.calories||"",productId:d.productId||""}]:[D]}:{dish:[D]},onSubmit:f,validationSchema:B,children:({errors:l,touched:c,values:m,setFieldValue:k})=>r.jsxs(se,{autoComplete:"off",children:[r.jsx(de,{name:"dish",children:({remove:F})=>r.jsx("ul",{children:m.dish.map((j,b)=>r.jsx("li",{children:r.jsx(Pe,{validation:u,index:b,errors:l,touched:c,values:m,setFieldValue:k,remove:F})},b))})}),t==="POST"&&(!s||s.length===0)&&r.jsx(Ne,{type:"button",onClick:F=>N(F,{values:m,setFieldValue:k,errors:l}),children:"+ Add more"}),r.jsxs(Te,{children:[r.jsx($e,{type:"submit",onClick:()=>{g()},children:"Confirm"}),r.jsx(ze,{type:"button",onClick:a,children:"Cancel"})]})]})})]})})},Re="/food_diary/assets/breakfast-d9429527.svg",We="/food_diary/assets/lunch-233cf7ab.svg",qe="/food_diary/assets/dinner-392691b4.svg",Ue="/food_diary/assets/snack-6fc8f33a.svg";export{Le as L,Be as M,Ue as a,Re as b,qe as d,We as l,n,q as s,_e as t};
