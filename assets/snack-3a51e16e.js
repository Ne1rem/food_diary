...
@media only screen and (min-width: 834px){
  ...
  gap: 12px;
  }`,B=M({dish:ie().of(M().shape({name:oe().required("Enter a name dish").min(2,"Very short"),carbonohidrates:N().required("Enter a number").max(999.99,"Maximum 999.99"),protein:N().required("Enter a number").max(999.99,"Maximum 999.99"),fat:N().required("Enter a number").max(999.99,"Maximum 999.99"),calories:N().required("Enter a number").max(999.99,"Maximum 999.99")}))}),D={name:"",carbonohidrates:"",protein:"",fat:"",calories:""},Be=({name:i,img:e,onClose:t,requestType:a,idIntake:s})=>{var b,z,_,v;const p=W(),[f,j]=k.useState(""),I=()=>{j("validation")};k.useEffect(()=>{const o=document.body.style.overflow,c=m=>{m.code==="Escape"&&t()};return window.addEventListener("keydown",c),document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",c),document.body.style.overflow=o}},[t]);const P=o=>{o.currentTarget===o.target&&t()},x=o=>{if(a==="POST"){const c={[i.toLowerCase()]:{dish:o.dish.map(m=>({name:m.name,carbonohidrates:parseFloat(m.carbonohidrates),protein:parseFloat(m.protein),fat:parseFloat(m.fat),calories:parseFloat(m.calories)}))}};p(G(c))}else if(a==="PUT"){const c={[i.toLowerCase()]:{dish:[{name:o.dish[0].name,carbonohidrates:parseFloat(o.dish[0].carbonohidrates),protein:parseFloat(o.dish[0].protein),fat:parseFloat(o.dish[0].fat),calories:parseFloat(o.dish[0].calories)}]}};console.log(s),console.log(c),p(H({id:s,intakeData:c}))}t()},g=4,$=(o,{values:c,setFieldValue:m,errors:w})=>{if(o.preventDefault(),a==="PUT")return;if(c.dish.some((y,u)=>!!(w.dish&&w.dish[u]))){j("validation");return}if(c.dish.length<g){const y=c.dish.length-1,u=c.dish[y];B.validate(u,{abortEarly:!1}).then(()=>{m("dish",[...c.dish,D])})}else return},h=q(R);let d;switch(i){case"breakfast":d=(b=h==null?void 0:h.breakfast)==null?void 0:b.dish;break;case"lunch":d=(z=h==null?void 0:h.lunch)==null?void 0:z.dish;break;case"dinner":d=(_=h==null?void 0:h.dinner)==null?void 0:_.dish;break;case"snack":d=(v=h==null?void 0:h.snack)==null?void 0:v.dish;break;default:d=null;break}const l=a==="PUT"?d.find(o=>o._id===s):null;return r.jsx(Pe,{onClick:P,children:r.jsxs(Se,{children:[r.jsx(Ee,{children:"Record your meal"}),r.jsxs(Ce,{children:[r.jsx("img",{src:e,alt:i}),r.jsx(Ie,{children:i})]}),r.jsx(ne,{initialValues:a==="POST"?{dish:d&&d.length?d.map(o=>({name:o.name||"",carbonohidrates:o.carbonohidrates||"",protein:o.protein||"",fat:o.fat||"",calories:o.calories||"",productId:o.productId||""})):[D]}:{dish:d&&d.length?[{name:l.name||"",carbonohidrates:l.carbonohidrates||"",protein:l.protein||"",fat:l.fat||"",calories:l.calories||"",productId:l.productId||""}]:[D]},onSubmit:x,validationSchema:B,children:({errors:o,touched:c,values:m,setFieldValue:w})=>r.jsxs(se,{autoComplete:"off",children:[r.jsx(de,{name:"dish",children:({remove:F})=>r.jsx("ul",{children:m.dish.map((y,u)=>r.jsx("li",{children:r.jsx(Fe,{validation:f,index:u,errors:o,touched:c,values:m,setFieldValue:w,remove:F})},u))})}),r.jsx($e,{type:"button",onClick:F=>$(F,{values:m,setFieldValue:w,errors:o}),children:"+ Add more"}),r.jsxs(Te,{children:[r.jsx(ze,{type:"submit",onClick:()=>{I()},children:"Confirm"}),r.jsx(Ne,{type:"button",onClick:t,children:"Cancel"})]})]})})]})})},We="/food_diary/assets/breakfast-d9429527.svg",qe="/food_diary/assets/lunch-233cf7ab.svg",Re="/food_diary/assets/dinner-392691b4.svg",Ue="/food_diary/assets/snack-6fc8f33a.svg";export{Le as L,Be as M,Ue as a,We as b,Re as d,qe as l,n,R as s,_e as t};
