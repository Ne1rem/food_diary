import{s as i,N as C,j as e,u as f,r as j,a as S}from"./index-bdd3a046.js";import{I as c,u as B,s as L}from"./InputStyle.styled-6c10d84e.js";import{T as x,a as g,I as h,B as d,i as v,A as N}from"./Illustration-0ac95e9d.js";import"./hoist-non-react-statics.cjs-3f8ebaa8.js";const A="/food_diary/assets/goals-12d0ed7f.png",F="/food_diary/assets/genderAndAge-42209e67.png",I="/food_diary/assets/bodyParameters-bce33dad.png",E="/food_diary/assets/illustrationActivity-1f59fd5a.png",T=i.div`
...
`,U=i(C)`
  ...
  line-height: 1.4;
`,M=({formik:n,increment:a})=>{const t=()=>{a()};return e.jsxs(T,{children:[e.jsx(x,{children:"Sign up"}),e.jsx(g,{children:"You need to register to use the service"}),e.jsxs(R,{children:[e.jsxs("li",{children:[e.jsx(c,{id:"name",name:"name",type:"name",placeholder:"Name",onChange:n.handleChange,value:n.values.name}),n.errors.name&&n.touched.name?e.jsx(h,{children:n.errors.name}):null]}),e.jsxs("li",{children:[e.jsx(c,{id:"email",name:"email",type:"email",placeholder:"E-mail",onChange:n.handleChange,value:n.values.email}),n.errors.email&&n.touched.email?e.jsx(h,{children:n.errors.email}):null]}),e.jsxs("li",{children:[e.jsx(c,{id:"password",name:"password",type:"password",placeholder:"Password",onChange:n.handleChange,value:n.values.password}),n.errors.password&&n.touched.password?e.jsx(h,{children:n.errors.password}):null]})]}),e.jsx(d,{onClick:()=>{t()},className:"btn-active",type:"button",children:"Next"}),e.jsxs($,{children:[e.jsx(G,{children:"Do you already have an account?"}),e.jsx(U,{to:"/signin",children:"Sign in"})]})]})},s=i.label`
   display: flex;
  align-items: center;
  cursor: pointer;
...
flex-direction: column;
gap: 12px;
`,D=({formik:n,increment:a,decrement:t})=>e.jsxs(k,{children:[e.jsx(x,{children:"Your goal"}),e.jsx(g,{children:"Choose a goal so that we can help you effectively"}),e.jsxs(Y,{children:[e.jsx("li",{children:e.jsxs(s,{children:[e.jsx("input",{onChange:n.handleChange,type:"radio",name:"goal",defaultChecked:!0,value:"Lose Fat"}),e.jsx(l,{}),e.jsx(r,{children:"Lose Fat"})]})}),e.jsx("li",{children:e.jsxs(s,{children:[e.jsx("input",{onChange:n.handleChange,type:"radio",name:"goal",value:"Maintain"}),e.jsx(l,{}),e.jsx(r,{children:"Maintain"})]})}),e.jsx("li",{children:e.jsxs(s,{children:[e.jsx("input",{onChange:n.handleChange,type:"radio",name:"goal",value:"Gain Muscle"}),e.jsx(l,{}),e.jsx(r,{children:"Gain Muscle"})]})})]}),e.jsxs(_,{children:[e.jsx("li",{children:e.jsx(d,{onClick:()=>{a()},className:"btn-active",type:"button",children:"Next"})}),e.jsx("li",{children:e.jsx(d,{onClick:()=>{t()},type:"button",children:"Back"})})]})]}),P=i.div`
  @media screen and (min-width: 1440px) {
    padding-top: 80px;
  }
`,H=i.ul`
