    ...
    return (
      <ModalSettigns>
        <ModalPartButtonSettigns>
          <ModalButtonSettigns to="/settings" onClick={() => setIsUserModalOpen(false)}>
            <ModalSvgSettigns>
              <use href={`${HeaderSvg}#settings`} />
            </ModalSvgSettigns>
            <ModalTextSettigns>Settings</ModalTextSettigns>
          </ModalButtonSettigns>
          <ModalButtonSettigns to="/" onClick={handleLogout}> 
            <ModalSvgSettigns>
              <use href={`${HeaderSvg}#logout`} />
            </ModalSvgSettigns>
            <ModalTextSettigns>Logout</ModalTextSettigns>
          </ModalButtonSettigns>
        </ModalPartButtonSettigns>
      </ModalSettigns>
    );
